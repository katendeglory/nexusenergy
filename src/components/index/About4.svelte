<script>
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Basic monthly checks and yearly inspections — we train local teams."
    }
  ];
  ...
  const contactInfo = {
    emails: {
      ...
      projects: "projects@[domain].com",
      careers: "careers@[domain].com"
    },
    phone: "+[country code] [number]",
    address: "[Street, City, Province, DRC]"
  };
...
<div class="bg-white text-gray-900">
  ...
  <section id="services" class="py-20">
    <Container>
      <div class="mx-auto max-w-4xl text-center mb-16" data-aos="fade-up">
        ...
        <h2 class="mt-4 text-3xl md:text-5xl xl:text-6xl font-bold leading-tight">
    ...
    <Container>
      <div class="grid gap-12 lg:grid-cols-[1fr_0.9fr] items-center">
        <div data-aos="fade-right">
          ...
          <h2 class="mt-4 text-3xl md:text-5xl font-bold leading-tight text-gray-900">
        ...
        >
          ...
          <p class="mt-6 text-sm text-gray-600 leading-relaxed">
            Join engineers, hydrologists, and community specialists working side by side to deliver clean energy solutions across the DRC.
          </p>
        </div>
      </div>
    </Container>
  ...
  <!-- Contact Section -->
  <section id="contact" class="relative overflow-hidden bg-slate-900 py-20 text-white">
    ...
    <Container>
      <div class="relative z-10">
        <div class="mx-auto max-w-4xl text-center mb-16" data-aos="fade-up">
          ...
          <p class="mt-6 text-sm md:text-base text-emerald-100 max-w-2xl mx-auto">
        ...
        <div class="grid gap-12 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div
            ...
            data-aos="fade-right"
          >
            <h3 class="text-xs uppercase tracking-[0.3em] text-emerald-300 mb-6">
              Send Inquiry
            </h3>
          ...
          <div class="space-y-8" data-aos="fade-left">
            <div>
              <h3 class="text-xs uppercase tracking-[0.3em] text-emerald-300 mb-4">
                Contact Information
              </h3>
              <div class="space-y-4">
                <div>
                  ...
                  <div class="space-y-2 text-sm text-emerald-100">
                    <p>
                      <span class="text-gray-400">General:</span> {contactInfo.emails.general}
                    </p>
                    <p>
                      <span class="text-gray-400">Projects:</span> {contactInfo.emails.projects}
                    </p>
                    <p>
                      <span class="text-gray-400">Careers:</span> {contactInfo.emails.careers}
                    </p>
                  </div>
                </div>
                <div>
