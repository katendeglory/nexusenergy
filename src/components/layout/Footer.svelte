      ...
      <div class="grid gap-12 md:grid-cols-4 mb-12">
        ...
        <div class="md:col-span-2" data-aos="fade-up">
          <div class="flex items-center gap-4 mb-6">
            ...
            />
            <div>
              <h3 class="text-2xl font-bold text-gray-900">New Nexus Energy</h3>
        ...
        <div data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="space-y-4 text-sm">
            <div>
              ...
              <a
                href="mailto:info@new-nexus.net"
      ...
      <div class="pt-8 border-t border-gray-200">
        ...
        >
          <p class="text-xs text-gray-500">
            © {new Date().getFullYear()} New Nexus Energy. {t(
              "All rights reserved.",
          ...
          <p class="text-xs text-gray-500">
            ...
            <a
              ...
              class="font-semibold text-emerald-600 hover:text-emerald-700 transition-colors ml-1"
            >
              Glory K.
            </a>
          </p>
